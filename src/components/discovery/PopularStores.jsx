...
import popularStores from "../../api/PopularStores.json";
  ...
  return (
    <div className="lg:p-8 p-2 lg:mx-4">
      <h2 className="mb-4 font-semibold text-lg md:text-xl lg:text-2xl">
        <Title>Populyar Mağazalar 🛒</Title>
      </h2>
          ...
          popularStores.map((store) => (
             <div className="px-2">
               <div className="!h-[270px] w-full overflow-hidden border-2 border-gray-200 rounded-2xl hover:scale-101 transition-all">
                <img className="w-full h-[220px] object-cover hover:scale-101" src={store.img} alt="" />
                <h3 className="text-sm md:text-lg lg:text-xl font-semibold text-center pt-3">{store.storeName}</h3>
              </div>
             </div>
          ))}
      </Slider>
